********************************************************************
* Lab 5 Robot Roaming Programming                                  *
* Author: Isaac Zheng                                              *
********************************************************************
; export symbols
...
LCD_CNTR        EQU PTJ ; control port
LCD_E           EQU $80 ; E-signal pin at PJ7 %10000000
LCD_RS          EQU $40 ; RS-signal pin at PJ6 %01000000
...
*******************************************************************
START_ST        BRCLR PORTAD0, $04, NO_FWD ; Bow bumper is at AN02 -> 00000100 -> $04. Branch to NO_FWD if it is clear (0=pressed)
                JSR INIT_FWD
...
*******************************************************************
FWD_ST          BRSET PORTAD0, $04, NO_FWD_BUMP ; Branch if bow bumper is set (1=not pressed)
                JSR INIT_REV ; If it is pressed reverse
                MOVB #REV, CRNT_STATE
                JMP FWD_EXIT
                
NO_FWD_BUMP     BRSET PORTAD0, $08, NO_REV_BUMP ; Branch if stern bumper is not pressed
                JSR INIT_ALL_STP
                MOVB #ALL_STP, CRNT_STATE
                JMP FWD_EXIT
                
NO_REV_BUMP     LDAA TOF_COUNTER ; If Tc>Tfwd
                CMPA T_FWD
                BNE NO_FWD_TRN
                JSR INIT_FWD_TRN ; the robot should go turn forward
...
; utility subroutines
*******************************************************************
initLCD     BSET DDRB,%11111111 ; configure all pins PB for output
...
UPDT_DISPL      MOVB #$90,ATDCTL5 ; R-just., uns., sing. conv., mult., ch=0, start
                ...
                JSR putcLCD
                LDAA #'.' ;adds decimal place to lcd monitor
                JSR putcLCD
                LDAA HUNDREDS
                JSR putcLCD
